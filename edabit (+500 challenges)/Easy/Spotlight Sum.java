...
public class Spotlight {
	public static int spotlightSum(int n) {	
		int spotlight = 0;
		spotlight = n + (n + 1) + (n - 1) + (n - 10) + (n + 10) + (n +9) + ( n + 11) + (n - 9) + ( n - 11);
		return spotlight;
	} 
}
...
public class Spotlight {
	public static int spotlightSum(int n) {return 9 * n;} 
}
...
public class Spotlight {
	public static int spotlightSum(int n) {	
        int row = (n - 11) + (n - 10) + (n - 9);
        int line = (n - 1) + n + (n + 1);
        int next = (n + 9) + (n + 10) + (n + 11);

        return row + line + next;
	} 
}
